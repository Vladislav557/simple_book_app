...
class ValidatorFieldException extends Exception implements CustomHttpExceptionInterface
{
    private const HTTP_CODE_EXCEPTION = Response::HTTP_BAD_REQUEST;
    private const HTTP_MESSAGE_EXCEPTION = 'validation error: ';
    ...
    {
        return self::HTTP_MESSAGE_EXCEPTION . $this->message;
    }
}